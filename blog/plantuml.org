...
1. 基础用法
  ...
  #+begin_src plantuml :file ../images/basic.png :cmdline -charset utf-8  :exports both
  autonumber
  Phone -> Server : 请求网页
...
2. 参与者名称和类型
  ...
  #+begin_src plantuml :file ../images/participant.png :cmdline -charset utf-8 :exports both
  actor Phone #ffff00
...
3. 表示 delay
   ...
   #+begin_src plantuml :file ../images/delay.png :cmdline -charset utf-8 :exports both
   actor Phone #ffff00
   database Server as s #41ead4
   Phone -> s : 请求网页
   ...
...
4. 配色配置
   ...
   #+begin_src plantuml :file ../images/skinparam.png :cmdline -charset utf-8 :exports both
